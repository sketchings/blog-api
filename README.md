# DevParent OpenAPI Specification
[![Build Status](https://travis-ci.org/sketchings/blog-api.svg?branch=master)](https://travis-ci.org/sketchings/blog-api)
...
6. If you did everything correct, https://sketchings.github.io/blog-api/ will lead to your new docs
...
- Documentation(ReDoc): https://sketchings.github.io/blog-api/
- SwaggerUI: https://sketchings.github.io/blog-api/swagger-ui/
- Look full spec:
    + JSON https://sketchings.github.io/blog-api/swagger.json
    + YAML https://sketchings.github.io/blog-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://sketchings.github.io/blog-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://sketchings.github.io/blog-api/ with url from the message: `Server started <url>`
